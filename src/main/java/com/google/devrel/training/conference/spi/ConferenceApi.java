...
public class ConferenceApi {
	...
	public Profile saveProfile(User u, ProfileForm pf) throws UnauthorizedException {

		String userId = u.getUserId();
		String mainEmail = u.getEmail();
		String displayName = pf.getDisplayName();
		TeeShirtSize teeShirtSize = pf.getTeeShirtSize();
	...
	public List<Conference> filterPlayground() {
		 ...
		 * 
		 * // Add a filter for maxAttendees query =
		 * query.filter("maxAttendees >", 8); query =
		 * query.filter("maxAttendees <",
